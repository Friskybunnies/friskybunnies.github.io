...
import './code.css';
import Yotpo from './images/Yotpo.png'
...
function Code() {
  return (
    <div className="code">
      ...
      <div className="slide">
        <div className="slide-title">Project #1: Four years of engineering achievements as a Senior Solutions Engineer at Yotpo</div>
        <div className="description">
        As a senior engineer at <a href="https://www.yotpo.com/" target="_blank" rel="noreferrer">Yotpo</a> (an e-commerce marketing software company), I've built tools to support numerous client brands and enable internal teams across an array of domains. A few of my contributions include custom notebooks for merchant Accounting teams, enhancements to GDPR customer anonymization processes, original assets like feature and metadata scripts, various SFTP deliverables, and new integrations built on external APIs, including Shopify's GraphQL Admin API, Google Workspace, and Customer.io. My clients include Barnes & Noble, Patagonia, Revlon, Smile Direct Club, Sony, Sodastream, DIRECTV, Nestle, VistaPrint, and more. Tools I use on a daily basis include Databricks, Python (PySpark), SQL, Cursor, HTML, Postman, Atlassian (Jira, Confluence, Opsgenie), GitHub, GraphQL, and Coralogix. I also use JavaScript, RubyMine, Kibana, Jenkins, Kubernetes, Grafana, Fullstory, React, Terraform, and CSS on a periodic basis.
        </div>
        <div className="yotpo">
          <img className="yotpo-image" src={Yotpo} alt="" />
        </div>
      </div>
      <div className="slide">
        <div className="slide-title">Project #2: Friskybunnies.com</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #3: G-MAFIA BAT mean-variance portfolio optimization using Sharpe ratio and Markowitz efficient frontier</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #4: Phosphorus and Recombine</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #5: RatTunnel.com</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #6: Predicting Pneumonia from Chest Radiographs with Deep Learning</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #10: BUG CATCHER, the non-stressful bug tracker</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #11: Predicting user religion from OkCupid profile data using machine learning methods</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #12: miniExtensions</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #13: Creative coding with p5.js</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #14: Pierre's Polynomial Mustache</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #15: Frisky Figures</div>
        <div className="description">
