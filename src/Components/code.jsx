...
function Code() {
  return (
    <div className="code">
      ...
      <div className="slide">
        <div className="slide-title">Project #6: Decent Labs</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #7: Outsite</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #8: ASL Letter Prediction with ResNet9 and PyTorch</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #9: BUG CATCHER, the non-stressful bug tracker</div>
        <div className="description">
      ...
      <div className="slide">
        <div className="slide-title">Project #10: Predicting user religion from OkCupid profile data using machine learning methods</div>
        <div className="description">
